    ...
    <Accordion defaultActiveKey="0">
      ...
      <Card>
        ...
        <Accordion.Collapse eventKey="2">
          <Card.Body>Opłaty za zamówienie można dokonać poprzez system płatności elektronicznej PayU, tradycyjnym przelewem bankowym, za pobraniem oraz ratalnie poprzez system rat online banku Alior.</Card.Body>
        </Accordion.Collapse>
      </Card>
      <Card>
        <Card.Header>
        ...
        <Accordion.Collapse eventKey="3">
          <Card.Body>Paczki doręczane są firmą spedytorską na zlecenie właściciela marki Photo inventions. Przewidywany czas doręczenia wynosi od 24 do 48 godzin od momentu skierowania zamówienia do realizacji. Przesyłki doręczane są od poniedziałku do piątku (za wyjątkiem dni świątecznych).</Card.Body>
        </Accordion.Collapse>
      </Card>
      <Card>
        <Card.Header>
      ...
      <Card>
        ...
        <Accordion.Collapse eventKey="6">
          <Card.Body>Paczka odbierana od kuriera nie powinna nosić śladów naruszenia, tj. wgnieceń, pęknięć, a taśma nie powinna być nacięta czy oderwana.
